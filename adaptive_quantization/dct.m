...
first_frame_rgb = double(imread('D:\我的坚果云\LAB_File\1\5\Chapter5\foreman20_40_RGB\foreman0020.bmp'));
...
for scaleIdx = 1 : numel(scales)
    ...
    bitperpixel_av_still_deblock(scaleIdx) = bitPerPixel;
    PSNR_av_still_deblock(scaleIdx) = PSNR;
end
